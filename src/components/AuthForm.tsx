    ...
    <div className="grid min-h-[72vh] place-items-center py-6 sm:py-8">
      <div className="grid w-full max-w-5xl gap-6 lg:grid-cols-[minmax(0,1fr)_420px] lg:items-center">
        <div className="hidden lg:block lg:pr-6">
          ...
          <h1 className="mt-4 max-w-xl text-4xl font-black uppercase leading-[0.95] tracking-tight text-white xl:text-5xl">
        ...
        <div className="animate-fade-up w-full">
          <div className="card rounded-xl p-6 sm:p-8">
            <div className="mb-6 text-center">
              <div className="mx-auto mb-4 grid h-12 w-12 place-items-center rounded-md border-2 border-[#0c0c13] bg-brand-600 shadow-[4px_4px_0_0_var(--vb-ink)] sm:h-14 sm:w-14">
